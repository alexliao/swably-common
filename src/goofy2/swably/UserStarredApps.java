...
public class UserStarredApps extends WithHeaderActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	enableSlidingMenu();
    	setContentView(R.layout.user_starred_apps);
    ...
    public void onPostCreate(Bundle savedInstanceState) {
		...
		UserLikedAppsFragment fragment = new UserLikedAppsFragment();
