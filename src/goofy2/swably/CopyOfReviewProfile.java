...
//        btnShareReview = this.findViewById(R.id.btnShareReview);
        ...
        btnCopy.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Utils.showToast(CopyOfReviewProfile.this, getString(R.string.copied));
...
//
			viewInreplyto.setOnClickListener(new View.OnClickListener(){
				@Override
				public void onClick(View v) {
					Intent i = new Intent(CopyOfReviewProfile.this, CopyOfReviewProfile.class);
    ...
    private void loadReview(final String id){
    	AsyncTask<Void, Void, Long> loadTask = new AsyncTask<Void, Void, Long>() {
			...
			protected Long doInBackground(Void... params) {
				try {
					mRet = Utils.getReviewInfo(CopyOfReviewProfile.this, id);
				} catch (Exception e) {
					mErr = e.getMessage();
				}
				return null;
            ...
            protected void onPostExecute(Long result) {
		    	...
		    	if(mErr != null){
		    		Utils.showToastLong(CopyOfReviewProfile.this, mErr);
		    	}
		    	hideLoading();
            }
        };
...
//    	if(app == null) return null; // in case opened from share link
    	return CopyOfReviewProfile.class.getName()+id;
    }
...
//					if(deleteReviewInWeb(mReview.optString("id"))){
					...
					Animation anim = AnimationUtils.loadAnimation(CopyOfReviewProfile.this, R.anim.shrink_out_to_up_right);
