...
public class SessionEvents {
    ...
    private LinkedList<AuthListener> mAuthListeners = new LinkedList<AuthListener>();
    private LinkedList<LogoutListener> mLogoutListeners = new LinkedList<LogoutListener>();
