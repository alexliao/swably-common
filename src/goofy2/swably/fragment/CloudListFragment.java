...
public abstract class CloudListFragment extends CloudFragment {
...
//		mList.setSelection(0);
	...
	protected void refreshListView() {
		mAdapter.notifyDataSetChanged();
//		hideRoundBorder();
		// Log.d(Const.APP_NAME, Const.APP_NAME + " CloudListFragment refreshListView");
		mIsDirty = false;
	}
