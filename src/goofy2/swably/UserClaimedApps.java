...
public class UserClaimedApps extends WithHeaderActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	enableSlidingMenu();
    	setContentView(R.layout.user_claimed_apps);
    ...
    public void onPostCreate(Bundle savedInstanceState) {
		...
		UserClaimedAppsFragment fragment = new UserClaimedAppsFragment();
